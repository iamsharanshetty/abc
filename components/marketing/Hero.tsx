        ...
        <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32">
            ...
            >
                ...
                <motion.p
                    ...
                    variants={item}
                >
                    You Need More Than a Chatbot. You Need a Website That Can Think. <br />
                ...
                >
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                        ...
                        {['Acme Corp', 'GlobalTech', 'Nebula', 'Velocity', 'FoxRun'].map((logo) => (
                            <span key={logo} className="text-xl font-bold font-serif text-slate-800 dark:text-slate-200">
                                {logo}
                            </span>
                        ))}
                    </div>
