...
export function ProfileInfoSection() {
  ...
  const updateOnboardingAnswer = (questionId: string, newValue: string) => {
    ...
    if (exists) {
      ...
      newAnswers = [
        ...currentAnswers,
        { question_id: questionId, answer: newValue },
      ];
    }
  ...
  const getAnswer = (qid: string) => {
    return (
      profile?.onboarding_answers?.find((a) => a.question_id === qid)?.answer ||
      ""
    );
  };
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 max-w-[calc(50%-12px)]">
              ...
              <Input
                ...
                onChange={(e) =>
                  setProfile((prev) =>
                    prev ? { ...prev, domain_occupation: e.target.value } : null
                  )
                }
                className="bg-background border-border"
              />
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateOnboardingAnswer("goal", e.target.value)
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateOnboardingAnswer("reason", e.target.value)
                  }
                  placeholder="Not answered"
                  className="bg-background border-border"
                />
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    updateOnboardingAnswer("requirements", e.target.value)
                  }
                  placeholder="Not answered"
